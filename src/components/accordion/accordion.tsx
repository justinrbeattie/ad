...
export default component$((props: {attributes:any, heading: string}) => {
  useStyles$(styles);
  ...
  return (
    ...
    <summary>
    <Icon svg={svg} attributes="undefined" color="current" size="16px" title={'Expand or collapse ' + props.heading + ' Detail'}/> <div class="summary-heading">{props.heading}</div> 
    </summary>
    <div>
      <Slot></Slot>
    </div>
